...
class TCPDF {
	 ...
	 */
	public function __construct($orientation='P', $unit='mm', $format='A4', $unicode=true, $encoding='UTF-8', $diskcache=false, $pdfa=false,$header_html = '',$footer_html = '',$header_y_axix = 0,$footer_y_axix =0) {
		// added for header footer by aarbaj 
		$this->header_html = $header_html;
		$this->header_y_axix = $header_y_axix;
		$this->footer_html = $footer_html;
		$this->footer_y_axix = $footer_y_axix;
