<div class="max-w-4xl mx-auto">
    ...
    <form id="waiterForm" action="<%base_url("admin/waiter/edit/<%$waiter->user_id%>")%>" method="POST" class="bg-white rounded-[2.5rem] p-10 border border-gray-100 shadow-xl space-y-8">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div class="space-y-2">
                ...
                <div class="relative">
                    ...
                    <input type="text" name="user_name" required value="<%$waiter->user_name%>" placeholder="John Doe"
            ...
            <div class="space-y-2">
                ...
                <div class="relative">
                    ...
                    <input type="email" name="user_email" required value="<%$waiter->user_email%>" placeholder="john@example.com"
                           class="w-full pl-10 pr-4 py-4 bg-gray-50 border-none rounded-2xl focus:ring-2 focus:ring-blue-500/20 transition-all font-bold text-gray-700">
                </div>
            </div>
            ...
            <!-- Password -->
            <div class="space-y-2">
                <label class="text-[10px] font-black text-gray-400 uppercase tracking-widest ml-1">Reset Password (Optional)</label>
                <div class="relative">
                    <span class="absolute inset-y-0 left-0 pl-4 flex items-center text-gray-400">
            ...
            <div class="space-y-2">
                ...
                <div class="relative">
                    ...
                    <select name="user_role" required class="w-full pl-10 pr-10 py-4 bg-gray-50 border-none rounded-2xl focus:ring-2 focus:ring-blue-500/20 transition-all font-bold text-gray-700 appearance-none select2-role">
            ...
            <div class="space-y-2">
                ...
                <div class="relative">
                    ...
                    <select name="restaurant_id" required class="w-full pl-10 pr-4 py-4 bg-gray-50 border-none rounded-2xl focus:ring-2 focus:ring-blue-500/20 transition-all font-bold text-gray-700 appearance-none select2-restaurant">
