...
class Auth extends My_Api_Controller
{
    ...
    public function register_post()
    {
        ...
        if ($this->form_validation->run() === false) {
            return $this->response(['success' => false, 'status' => false, 'errors' => $this->form_validation->error_array(), 'data' => []], REST_Controller::HTTP_BAD_REQUEST);
        }
    ...
    public function login()
    {
        ...
        if (!$user || !$this->verify_password($input['password'], $user->user_password)) {
            ...
            return $this->response(['success' => false, 'status' => false, 'message' => 'Invalid credentials', 'data' => []], REST_Controller::HTTP_UNAUTHORIZED);
        }
        ...
        return $this->response(['success' => true,'message' => 'Login successful', 'data' => ['id' => $user->user_id,'token' => $token, 'name' => $user->user_name, 'email' => $user->user_email, 'restaurant_id' => $user->restaurant_id]], REST_Controller::HTTP_OK);
    }
    public function logout()
    {
        ...
        return $this->response(['success' => true, 'status' => true, 'message' => 'Logged out', 'data' => []], REST_Controller::HTTP_OK);
    }
}