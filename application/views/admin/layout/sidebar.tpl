<aside class="hidden lg:flex lg:flex-shrink-0 w-64 h-screen overflow-hidden bg-gray-900 text-white flex-col transition-all duration-300">
    ...
    <nav class="flex-1 px-4 mt-4 space-y-1 overflow-y-auto">
        ...
        <!-- Master -->
        <a href="<%base_url('admin/menu')%>" class="flex items-center px-4 py-3 text-sm font-medium rounded-lg hover:bg-gray-800 transition-all duration-300 <%if $current_module == 'menu' && $current_controller == 'menu'%>sidebar-active<%/if%>" title="Menu Items">
        ...
        <a href="<%base_url('admin/category_master')%>" class="flex items-center px-4 py-3 text-sm font-medium rounded-lg hover:bg-gray-800 transition-all duration-300 <%if $current_module == 'menu' && $current_controller == 'category_master'%>sidebar-active<%/if%>" title="Category Master">
            <i class="fa-solid fa-tags w-6 text-center"></i>
            <span class="sidebar-label ml-3 transition-opacity duration-300">Category Master</span>
        </a>
        <a href="<%base_url('admin/floor_master')%>" class="flex items-center px-4 py-3 text-sm font-medium rounded-lg hover:bg-gray-800 transition-all duration-300 <%if $current_module == 'floor_master'%>sidebar-active<%/if%>" title="Floor Master">
            <i class="fa-solid fa-layer-group w-6 text-center"></i>
            <span class="sidebar-label ml-3 transition-opacity duration-300">Floor Master</span>
        </a>
...
<style>
    ...
    aside nav::-webkit-scrollbar-thumb { background: #374151; border-radius: 10px; }
    aside nav::-webkit-scrollbar-thumb:hover { background: #4b5563; }
</style>